package
{
	...
	public class PlayState extends BasePlayState
	{
		...
		function PlayState():void
		{
			...
			// Create the level
			var currLevelClass:Class = levelArray[KimJongIll.currLevelIndex];
		...
		{
			KimJongIll.currLevelIndex++;
			if( KimJongIll.currLevelIndex > levelArray.length - 1 )
			{
				KimJongIll.currLevelIndex = 0;
			}
